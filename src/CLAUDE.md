...
| 变量 | 值 | 用途 |
|------|----|------|
| `--bg-base` | `#0f0f13` | 页面最底层背景 |
| `--bg-surface` | `#16161d` | 侧边栏、卡片底色 |
| `--bg-elevated` | `#1e1e28` | 弹窗、悬浮面板 |
| `--bg-hover` | `#252532` | 悬停高亮 |
| `--border` | `#2a2a38` | 默认边框 |
| `--border-light` | `#333345` | 次级边框 |
| `--text-primary` | `#e8e8f0` | 主要文字 |
| `--text-secondary` | `#8888aa` | 次要文字 |
| `--text-muted` | `#55556a` | 占位 / 辅助 |
| `--accent` | `#7c6af7` | 主色调（紫） |
| `--accent-dim` | `rgba(124,106,247,.15)` | 主色调背景 |
| `--gold` | `#c9a84c` | AI 消息 / 高亮颜色 |
